<template>
  <svg viewBox="0 0 512 512">
    <g>
      <path
        class="transition-fill-opacity duration-1000 delay-500 ease-out"
        :style="{
      ...
      />
      <path
        class="transition-fill-opacity duration-1000 delay-700 ease-out"
        :style="{
          'fill-opacity': visible ? 1 : 0
        }"
        fill="currentColor"
      ...
      />
      <ellipse
        class="transition-fill-opacity duration-1000 delay-1000 ease-out"
        :style="{
          'fill-opacity': visible ? 1 : 0
        }"
        fill="currentColor"
